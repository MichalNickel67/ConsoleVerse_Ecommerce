    ...
    <?php
        ...
        if (mysqli_num_rows($result) > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<p class='card-text'>Product ID: ".$row["prod_id"]."<br>"."Full Name: ".$row["fullname"]."<br>"."Email: ".$row["email"]."<br>"."Price: £".$row["price"]."</p>";
                echo "</div>";
                echo "<div class='col-md-4'>";
                echo "<div class='position-relative'>";
                echo "<img src='".$row["img"]."' class='img-fluid small-image' style='max-width: 100%; max-height: 100%;'>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
                echo "<div class='card-buttons d-flex justify-content-end'>";
                echo "<a href='DeleteProductinBasket.php?prod_id=".$row["prod_id"]."' class='btn btn-danger'>Remove from Basket</a>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
                echo "</div>";
            ...
            echo "<div class='container-fluid mt-3 text-center'>";
            echo "<h2 class='font-weight-bold'>Your Total is: £" . number_format($totalPrice, 2) . "</h2>"; //Sets totalprice as a decimal to prevent errors in calculation https://www.w3schools.com/php/func_string_number_format.asp
            echo "<a href='AddressFORM.php' class='btn btn-outline-warning mx-2'>Proceed To Checkout</a>";
            echo "</div>";
        }
        else {
            echo "<div class='container-fluid'>";
            ...
            echo "<div class='card-body'>";
            echo "<h4 class='card-title'>No Products Found in Basket</h4>";
            echo "<p style='font-size: 5em;'>😢</p>";
            echo "<p class='card-text'>Your basket is currently empty. Explore our console collection and add some items!</p>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
            echo "</div>";
