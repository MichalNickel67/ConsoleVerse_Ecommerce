...
<body>
    ...
    <div class="row justify-content-between align-items-center">
        <h1 class="mb-0"><b>My Orders</b></h1>
    </div>
</div>
...
<div class="container">
    <div class="row">
        <?php
            $sql = "SELECT * FROM orderhistory WHERE email = '" . $_SESSION['email'] . "'";
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class="col-md-6 mt-3">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Order Number: <?php echo $row['order_number']; ?></h5>
                                <p class="card-text">Product Name: <?php echo $row['product_name']; ?></p>
                                <p class="card-text">Full Name: <?php echo $row['fullname']; ?></p>
                                ...
                                <div class='card-buttons d-flex justify-content-end'>
                                    <a href='CancelOrder_Script.php?order_id=<?php echo $row["order_id"];?>' class='btn btn-danger'>Cancel Order</a>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                echo "<h4 class='card-title'>No Orders Placed</h4>";
                echo "<p class='card-text'>You have not placed any orders just yet. Check out our console collection and add some items to your basket!</p>";
