...
<body>
    ...
    <div class="container mt-3">
        <div class="row justify-content-between align-items-center">
            <form class="d-flex">
                <h1 class="mb-0"><b>NINTENDO <img src="Images/logo.png" width="5%" /> </b></h1>
                <a href="viewBasket.php" class="btn button-nintendo d-flex align-items-center" href="viewBasket.php">
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class='card h-100 d-flex flex-column'>
                        ...
                        <div class='card-body text-center flex-grow-1 d-flex flex-column justify-content-between'>
                            ...
                            <div class='mt-auto'>
                                <a href='detailsNI.php?prod_id=".$row["prod_id"]."' class='btn button-nintendo'>More Details</a>
                            </div>
                        </div>
                    </div>
                </div>";
