            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    ...
                    <div class="card-body">
                        ...
                        <form action="AddProduct_Script.php" method="post" class="needs-validation" novalidate>
                            ...
                            <div class="form-group">
                                ...
                                <textarea class="form-control" id="descrip" name="descrip" rows="4"></textarea>
                            </div>

                            <div class="form-group">
                                <label for="stock">Stock Available:</label>
                                <input type="number" class="form-control form-control-sm" id="stock" name="stock" value="" style="width: 100px;">
                            </div>

                            <div class="form-group">
                                <label for="rating">Rating Out of 5:</label>
                                <input type="number" class="form-control form-control-sm" id="rating" name="rating" min="0" max="5" value="" style="width: 100px;">
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                CPU: <input type="text" class="form-control" name="cpu" value=""><br>
                                GPU: <input type="text" class="form-control" name="gpu" value=""><br>
                                Memory: <input type="text" class="form-control" name="memory" value=""><br>
                                Storage: <input type="text" class="form-control" name="storage" value=""><br>
