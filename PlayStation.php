...
<body>
    ...
    <div class="container mt-3">
        <div class="row justify-content-between align-items-center">
            <div class="col text-center">
                <form class="d-flex">
                    <h1 class="mb-0"><b>PLAYSTATION <img src="Images/pslogo.png" width="5%" /> </b></h1>
                    <a href="viewBasket.php" class="btn button-playstation d-flex align-items-center" href="viewBasket.php">
                        <i class="bi-cart-fill me-1 text-white"></i>
                        Basket
                        <span id="cartCounter" class="badge bg-light text-dark ms-1 rounded-pill"></span>
                    </a>
                </form>
            </div>
        </div>
    ...
    <section class="py-5">
        ...
        <?php
            $sql = "SELECT * FROM products WHERE brand = 'PlayStation'";
            ...
            if (mysqli_num_rows($result) > 0) {
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    if ($count % 4 == 0) { #Start a new row for every 4th card
                        echo "<div class='container-fluid'>
                                <div class='row'>";
                    }
                    echo "<div class='col-md-3'>
                    <div class='card h-100 d-flex flex-column'>
                        <img src='".$row["img"]."' alt='".$row["brand"].$row["model"]."' class='card-img-top' width='100%' height='auto'/>
                        <div class='card-body text-center flex-grow-1 d-flex flex-column justify-content-between'>
                            <h5 class='fw-bolder'>".$row["brand"]." ".$row["model"]."</h5>
                            ...
                            <div class='mt-auto'>
                                <a href='detailsPS.php?prod_id=".$row["prod_id"]."' class='btn button-playstation'>More Details</a>
                            </div>
                        </div>
                    </div>
                </div>";
