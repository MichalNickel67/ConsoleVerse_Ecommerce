                    ...
                    <div class="card-body">
                        <?php
                            if(!isset($_SESSION["email"])) {
                                echo "<h1 class='text-center mb-4'>Sign In</h1>";
                                echo "<form action='signinvalidation.php' method='post'>";
                                echo "<div class='mb-3'>";
                                echo "<label for='email' class='form-label'>Email:</label>";
                                echo "<input type='email' class='form-control' id='email' placeholder='example@example.com' name='email' pattern='(a-z0-9._%+\-)+@(a-z0-9.\-)+\.(a-z){2,}$' required>";
                                echo "<div class='valid-feedback'>Looks good!</div>";
                                echo "<div class='invalid-feedback'>Please enter a valid Email Address.</div>";
                                echo "</div>";
                                echo "<div class='mb-3'>";
                                echo "<label for='pwd' class='form-label'>Password:</label>";
                                echo "<input type='password' class='form-control' id='pwd' placeholder='Enter password' name='pswd' required>";
                                ...
                                echo "Don't Have an Account? <a href='Register.php' class='fw-bold'><u>Register here</u></a>";
                                echo "</p>";
                                echo "</form>";
                            }
                            else {
