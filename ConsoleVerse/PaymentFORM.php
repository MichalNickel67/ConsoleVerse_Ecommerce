        ...
        <div class="col-lg-8">
            <div class="card shadow">
                <div class="card-header bg-primary text-white">
                    <h5 class="card-title mb-0">Buy Now</h5>
                </div>
                <div class="card-body">
                    
                    <form action="Payment_Script.php" method="post" class="needs-validation" novalidate>

                        <div class="form-group">
                            <label for="cardno">Enter Card Number:</label>
                            <input type="text" class="form-control form-control-sm" id="cardno" name="cardno" pattern="[0-9]{16}" title="Please enter a 16-digit card number" required>
                            <div class="invalid-feedback">Please enter a valid 16-digit card number.</div>
                        </div>

                        <div class="form-group">
                            <label for="sortcode">Enter Sort Code:</label>
                            <input type="text" class="form-control form-control-sm" id="sortcode" name="sortcode" pattern="[0-9]{6}" title="Please enter a 6-digit sort code" required>
                            <div class="invalid-feedback">Please enter a valid 6-digit sort code.</div>
                        </div>

                        <div class="form-group">
                            <label for="securitycode">Enter 3-Digit Security Number:</label>
                            <input type="text" class="form-control form-control-sm" id="securitycode" name="securitycode" pattern="[0-9]{3}" title="Please enter a 3-digit security number" required>
                            <div class="invalid-feedback">Please enter a valid 3-digit security number.</div>
                        </div>
