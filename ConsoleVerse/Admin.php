...
<body>
    ...
    <h1><b>Welcome <?php echo $_SESSION["fullname"]; ?></b></h1>
    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <div class="mb-3">
                    <a class='btn btn-outline-primary mx-2' href='MyAccount.php'>
                        <i class="bi bi-person"></i> Update My Account
                    </a>
                    <a class='btn btn-outline-success mx-2' href='AccountList.php'>
                        <i class="bi bi-people"></i> Update User's Account
                    </a>
                    <a class='btn btn-outline-secondary mx-2' href='ViewAllOrders.php'>
                        <i class="bi bi-file-earmark-text"></i> View All Orders
                    </a>
                    <a class='btn btn-outline-danger mx-2' href='ProductsList.php'>
                        <i class="bi bi-grid"></i> Products List
                    </a>
                </div>
                <div class="mb-3">
                    <a class='btn btn-outline-warning mx-2' href='ViewOrders.php'>
                        <i class="bi bi-file-earmark-text"></i> View Orders
                    </a>
                    <a class='btn btn-outline-info mx-2' href='ViewBasket.php'>
                        <i class="bi bi-cart3"></i> View Basket
                    </a>
                    <a class='btn btn-outline-light mx-2' href='Logout.php'>
