...
<body>
    ...
    <?php
        ...
        while($row=mysqli_fetch_assoc($result)){
            ...
            mysqli_query($con, "INSERT INTO orderHistory (order_id, prod_id, quantity, email VALUES ('$order_id','$prod_id','$quantity','$email')");
        }

        mysqli_query($con, "DELETE FROM basket WHERE email='$email'");
