...
<body>
    ...
    <div class="container mt-3">
        <div class="row justify-content-between align-items-center">
            <div class="col text-center">
                <form class="d-flex">
                    <h1 class="mb-0"><b>XBOX <img src="Images/xboxlogo.png" width="5%" /> </b></h1>
                    <a href="viewBasket.php" class="btn button-xbox d-flex align-items-center" href="viewBasket.php">
    ...
    <section class="py-5">
        ...
        <?php
            $sql = "SELECT * FROM products WHERE brand = 'Xbox'";
                ...
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    <div class='card h-100 d-flex flex-column'>
                        ...
                        <div class='card-body text-center flex-grow-1 d-flex flex-column justify-content-between'>
                            ...
                            <div class='mt-auto'>
                                <a href='detailsXB.php?prod_id=".$row["prod_id"]."' class='btn button-xbox'>More Details</a>
                            </div>
                        </div>
                    </div>
                </div>";
