...
<body>
    ...
    <div class='container-fluid'>
        <div class='row justify-content-center'>
            <div class='col-md-6'>
            <h1 class="mb-4"><b>Registered Successfully</b></h1>
                <div class='card text-center'>
                    <div class='card-body'>
                        <p style='font-size: 5em;'>😁</p>
                        <p class='card-text'>Account Created Successfully<br>You can now sign in below!</p>
                        <a href="SignIn.php" class="btn btn-outline-primary mt-3">Sign In</a>
                    </div>
                </div>
            </div>
        </div>
