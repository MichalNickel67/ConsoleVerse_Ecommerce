    ...
    <div class="container-fluid">
        <div class="row justify-content-center">
            <div class="col-md-6 text-center">
                <div class="mb-3">
                    <a class='btn btn-outline-success mx-2' href='MyAccount.php'>
                        <i class="bi bi-people"></i> Update My Account
                    </a>
                    ...
                    <a class='btn btn-outline-light mx-2 mx-2' href='Logout.php'>Log Out</a>
                </div>
            </div>
        </div>
    </div>
