...
<head>
    <title>Modify My Account Form</title>
    <meta charset="utf-8" />
            ...
            <div class="col-lg-8">
                <div class="card shadow">
                    <div class="card-header bg-primary text-white">
                        <h5 class="card-title mb-0">Edit Account Details</h5>
                    </div>
                    <div class="card-body">
                        
                        <form action="MyAccount_Script.php" method="post" class="needs-validation" novalidate>
                            <div class="form-group">
                                <h1>Account ID: <?php echo $row['acc_id']; ?></h1>
                            ...
                            <div class="form-group">
                                ...
                                <input type="email" class="form-control" pattern="(a-z0-9._%+\-)+@(a-z0-9.\-)+\.(a-z){2,}$" required id="email" name="email" value="<?php echo $row["email"]; ?>">
                            </div>

                            <div class="form-group">
                                <label for="phone_number">Phone Number:</label>
                                <input type="text" class="form-control" pattern="[0-9]{11}" required id="phone_number" name="phone_number" value="<?php echo $row["phone_number"]; ?>">
                            </div>

                            <div class="form-group">
                                <label for="password">Enter Password:</label>
                                <input type="text" class="form-control" pattern="[0-9]{11}" required id="password" name="password" value="<?php echo $row["password"]; ?>">
                            </div>
